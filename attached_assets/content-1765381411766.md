```json
{
  ...
  "$id": "https://movielabs.com/omc/json/schema/v2.8",
  "title": "OMC-JSON Schema v2.8",
  "$comment": "Copyright 2021-2025 Motion Picture Laboratories, Inc.\nSPDX-License-Identifier: APACHE-2.0",
  "oneOf": [
        ...
        "Asset": {
            ...
            "assetFC": {
              ...
              "properties": {
                ...
                "functionalProperties": {
                  ...
                  "properties": {
                    "audioChannelName": {"$ref": "#/$defs/Asset/properties/Asset/$defs/audioChannelName"},
                    "audioContent": {"$ref": "#/$defs/Utility/properties/audioContent"},
                    "audioMixType": {"$ref": "#/$defs/Asset/properties/Asset/$defs/audioMixType"},
                    "audioProcessingAction": {"$ref": "#/$defs/Asset/properties/Asset/$defs/audioProcessingAction"},
                    "audioTrackName": {"$ref": "#/$defs/Asset/properties/Asset/$defs/audioTrackName"},
                    "cameraMetadata": {"$ref": "#/$defs/Asset/properties/Asset/$defs/cameraMetadata"},
                    "cgVolumePurpose": {"$ref": "#/$defs/Asset/properties/Asset/$defs/cgVolumePurpose"},
                    ...
                    "soundfield": {"$ref": "#/$defs/Utility/properties/soundfield"},
                    "timing": {"$ref": "#/$defs/Asset/properties/Asset/$defs/timing"},
                    "scd": {"$ref": "#/$defs/Asset/properties/Asset/$defs/scd"},
                    "udimTileNumber": {"$ref": "#/$defs/Asset/properties/Asset/$defs/udimTileNumber"}
                  }
                },
          ...
          "$defs": {
            ...
            "cgVolumePurpose": {
              ...
              "description": "The intended use of a CG Volume in the CG pipeline."
            },
            "isSelfContained": {
              "type": [
                "boolean",
            ...
            "udimTileNumber": {
              ...
              "title": "UDIM Tile Number",
              "description": "A numbered sub-piece of a UV Map"
            }
          },
          "unevaluatedProperties": false
        },
        "AssetSC": {
          ...
          "properties": {
            ...
            "structuralType": {
              ...
              "description": "A canonical description of the the assets form.",
              "x-controlledValues": [
                "assetGroup",
                "digital",
                "digital.audio",
            ...
            "structuralProperties": {
              ...
              "properties": {
                ...
                "audioBitRate": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/audioBitRate"},
                "audioSampleRate": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/audioSampleRate"},
                "audioSampleSize": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/audioSampleSize"},
                "axisAligned": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/axisAligned"},
                "boundingBox": {"$ref": "#/$defs/Utility/properties/boundingBox"},
                "cgVolumePurpose": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/cgVolumePurpose"},
                "codec": {"$ref": "#/$defs/Utility/properties/codec"},
                ...
                "numberPoints": {"$ref": "#/$defs/Asset/properties/AssetSC/$defs/numberPoints"}
              },
              "additionalProperties": false
            },
            "isAnalog": {
            ...
            "software": {
              "type": "array",
              "title": "Software",
              "description": "A description of any software that might be connected to this AssetSC, typically the one that generated it.",
              "$ref": "#/$defs/Utility/properties/software"
            },
            "Carrier": {
              "title": "Carrier",
          ...
          "$defs": {
            ...
            "axisAligned": {
              ...
              "title": "Axis Aligned",
              "description": "True if the volume is aligned with the three axes of the coordinate space."
            },
            "audioBitRate": {
              "type": [
                "integer",
            ...
            "numberPoints": {
              ...
              "description": "The number of individual points in the Point Cloud."
            }
          },
          "unevaluatedProperties": false
        }
        ...
        "Service": {
          ...
          "properties": {
            ...
            "software": {
              "type": "array",
              "title": "Software",
              "description": "A description of any software used by the Service",
              "$ref": "#/$defs/Utility/properties/software"
            }
          },
          "required": ["entityType"],
        ...
        "Collection": {
          ...
          "properties": {
            ...
            "collectionType": {
              ...
              "description": "The type, or sub-class, of this specific Collection.",
              "x-controlledValues": ["collection"]
            },
            "includes": {
              "oneOf": [
                {"$ref": "#/$defs/core/properties/collectionObject"},
                {"$ref": "#/$defs/core/properties/rootEntity"},
                {
                  "type": "array",
                  "items": {"$ref": "#/$defs/core/properties/rootEntity"}
            ...
            "software": {
              "type": "array",
              "title": "Software",
              "description": "A description of any software that might be connected to this Composition, typically those used in generating the final product.",
              "$ref": "#/$defs/Utility/properties/software"
            }
          },
          "unevaluatedProperties": false,
          "required": ["entityType"],
          "title": "Collection",
          "description": "A bundle of OMC entities, each of which must have an Identifier."
        },
        "Composition": {
          "type": "object",
          "title": "Composition",
          ...
          "properties": {
            ...
            "compositionProperties": {
              ...
              "properties": {
                ...
                "coordinateOrientation": {"$ref": "#/$defs/Utility/properties/coordinateOrientation"},
                "levelOfDetail": {"$ref": "#/$defs/Utility/properties/levelOfDetail"},
                "materialType": {"$ref": "#/$defs/Utility/properties/materialType"},
                "purpose": {"$ref": "#/$defs/Utility/properties/purpose"},
                "scale": {"$ref": "#/$defs/Utility/properties/scale"},
                "soundfield": {"$ref": "#/$defs/Utility/properties/soundfield"}
              }
        ...
        "customData": {
          ...
          "oneOf": [
            {"type": "null"},
            {
              ...
              "maxProperties": 0,
              "deprecated": true,
              "description": "Deprecated in favor of an array objects, with explicit provenance to allow for disambiguation."
            },
            {
              "type": "array",
              "items": {
                ...
                "properties": {
                  "domain": {
                    "title": "Custom Data Domain",
                    "description": "Indicates the set or system in which the Custom Data is relevant or defined",
                    "type": "string"
                  },
                  "namespace": {
                    "title": "Custom Data Namespace",
                    "description": "The namespace used by the Custom Data",
                    "type": "string"
                  },
                  "schema": {
                    "title": "Custom Data Schema",
                    "description": "URL for the schema used by the Custom Data",
                    "type": "string"
                  },
                  "value": {
                    "title": "Custom Data Value",
                    "description": "The user defined custom data",
                    "type": [
                      "object",
                      "array",
                      "string",
        ...
        "audioContent": {
          ...
          "items": {
            "properties": {
              ...
              "language": {"$ref": "#/$defs/Utility/properties/language"}
            }
          },
        ...
        "software": {
          ...
          "properties": {
            ...
            "softwareVersion": {
              ...
              "description": "A version ascribed to the software that was used."
            },
            "apiVersion": {
              "title": "API Version",
              "description": "For applications or SAAS services where an API is used.",
              "type": [
                "string",
                "null"
              ]
            ...
            "plugin": {
              "title": "Plugin",
              "description": "A list of required plugins, these are also software",
              "type": [
                "array",
                "null"
              ],
            ...
            "operatingSystem": {
              ...
              "description": "The operating system that used, which is 'software'",
              "$ref": "#/$defs/Utility/properties/software"
            },
            "parameters": {
              "type": [
              ...
              "title": "Parameters",
              "description": "Parameters used when executing the software, such as in a command line"
            },
            "ConfigurationFile": {
              "type": [
                "array",
              ...
              "description": "Optional reference to an file(Asset) containing additional configuration or other information.",
              "items": {
                "anyOf": [
                  {"$ref": "#/$defs/core/properties/reference"},
                  {"$ref": "#/$defs/Asset/properties/Asset"}
          ...
          "title": "Software",
          "description": "A set of executable instructions that tells a computer how to operate."
        },
        "provenance": {
          "type": [
            "object",
        ...
        "rootObject": {
          ...
          "properties": {
            ...
            "Collection": {
              ...
              "items": {"$ref": "#/$defs/Utility/properties/Collection"},
              "title": "Collection"
            },
            "Location": {
              "type": [
          ...
          "properties": {
            ...
            "Collection": {
              ...
              "items": {
                "anyOf": [
                  {"$ref": "#/$defs/core/properties/reference"},
                  {"$ref": "#/$defs/Utility/properties/Collection"}
                ]
              },
              "title": "Collection"
            },
          ...
          "allOf": [
            ...
            },
            {
              "if": {
                "type": "object",
                "properties": {
                  "entityType": {"const": "Collection"}
                },
                "required": ["entityType"]
              },
              "then": {"$ref": "#/$defs/Utility/properties/Collection"}
            }
          ]
        },
        "baseEntity": {
          ...
          "title": "Base Entity Properties",
          "description": "The set of base properties present on all entities"
        },
        "baseVersion": {
          "type": [
            "object",
